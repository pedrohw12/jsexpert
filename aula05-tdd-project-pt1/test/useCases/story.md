...
// Seed is a pattern to generate a database
// Within entities, there is the entity 'base', which is the entity that will serve as the base properties that will be present in all the models